;(function (window) {
    ...
    let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'HAI', 'HALO ZUMROTUS', 'SEMANGAT YA', 'KAMU HEBAT!', 'KAMU CANTIK', 'HARI INI KAMU SAKIT', 'TAPI MASIH KERJA', 'JANGAN DI PAKSA YA', 'NANTI KALO KAMU SAKIT', 'AKU JADI SEDIH', 'I', 'LOVE', 'YOU ♡', 'JANGAN LUPA ISTIRAHAT', 'MAKAN', 'MAAFIN AKU YA', 'AKU SAYANG KAMU']
  ...
  function handleMobileView() {
    document.getElementById('someElement').style.fontSize = '16px';
}
